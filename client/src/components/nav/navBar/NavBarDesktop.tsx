import { Button as ButtonMui, ButtonProps, Grid, Hidden, Stack, Typography } from "@mui/material";
...
const Menu: React.FC<TMenuProps> = () => {
    ...
    return (
        <Stack alignItems={"center"} justifyContent={"center"} style={{ position: 'relative' }} onClick={() => setOpen(!open)} onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
            <TypographyStyled theme={theme}>Menu</TypographyStyled>
            <MenuContainer theme={theme} open={open}>
                <Stack alignItems={"center"} justifyContent={"space-around"} style={{ position: 'relative' }}>
                    <LinkA href="#home">Home</LinkA>
                    <LinkA href="#aboutUs">About us</LinkA>
                    <LinkA href="#howItWorks">How it works</LinkA>
                    <LinkA href="#contact">Contact</LinkA>
